ATTACH TABLE _ UUID 'b5991102-1026-40cc-a23e-211466c55809'
(
    ...
    `ProfileEvent_S3QueueFailedFiles` UInt64 COMMENT 'Number of files which failed to be processed',
    `ProfileEvent_S3QueueProcessedFiles` UInt64 COMMENT 'Number of files which were processed',
